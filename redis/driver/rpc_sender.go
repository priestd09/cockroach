...
// RPCMethod is the name of the RPC method for Redis requests.
const RPCMethod = "Server.Redis"

// rpcSender is an implementation of Sender which exposes the Redis database
...
func (s *rpcSender) Send(args Command) (Response, error) {
	if args.GetUser() == "" {
		args.User = s.user
	}
