...
type ImportDetails struct {
	...
	TableProgress []ImportDetails_TableProgress `protobuf:"bytes,2,rep,name=table_progress,json=tableProgress" json:"table_progress"`
}
...
// TableProgress tracks progress of the distributed import.
type ImportDetails_TableProgress struct {
	// URIs tracks progress of reading each data file.
	URIs map[string]*ImportDetails_TableProgress_Progress `protobuf:"bytes,1,rep,name=uris" json:"uris,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	// KVs tracks progress of writing temp KVs.
	KVs map[string]*ImportDetails_TableProgress_Progress `protobuf:"bytes,2,rep,name=kvs" json:"kvs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	// SSTs tracks progress of writing final SSTs.
	SSTs map[string]*ImportDetails_TableProgress_Progress `protobuf:"bytes,3,rep,name=ssts" json:"ssts,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *ImportDetails_TableProgress) Reset()         { *m = ImportDetails_TableProgress{} }
func (m *ImportDetails_TableProgress) String() string { return proto.CompactTextString(m) }
func (*ImportDetails_TableProgress) ProtoMessage()    {}
func (*ImportDetails_TableProgress) Descriptor() ([]byte, []int) {
	return fileDescriptorJobs, []int{3, 1}
}

type ImportDetails_TableProgress_Progress struct {
	// Total number of things that will be processed (bytes to read, KVs or SSTs to write).
	Total int64 `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`
	// Percent (between 0 and 1) complete of the total.
	Done float32 `protobuf:"fixed32,2,opt,name=done,proto3" json:"done,omitempty"`
}

func (m *ImportDetails_TableProgress_Progress) Reset()         { *m = ImportDetails_TableProgress_Progress{} }
func (m *ImportDetails_TableProgress_Progress) String() string { return proto.CompactTextString(m) }
func (*ImportDetails_TableProgress_Progress) ProtoMessage()    {}
func (*ImportDetails_TableProgress_Progress) Descriptor() ([]byte, []int) {
	return fileDescriptorJobs, []int{3, 1, 0}
}
...
func init() {
	...
	proto.RegisterType((*ImportDetails_TableProgress)(nil), "cockroach.sql.jobs.ImportDetails.TableProgress")
	proto.RegisterType((*ImportDetails_TableProgress_Progress)(nil), "cockroach.sql.jobs.ImportDetails.TableProgress.Progress")
...
func (m *ImportDetails) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.TableProgress) > 0 {
		for _, msg := range m.TableProgress {
			dAtA[i] = 0x12
			i++
			i = encodeVarintJobs(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *ImportDetails_TableProgress) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ImportDetails_TableProgress) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.URIs) > 0 {
		keysForURIs := make([]string, 0, len(m.URIs))
		for k := range m.URIs {
			keysForURIs = append(keysForURIs, string(k))
		}
		github_com_gogo_protobuf_sortkeys.Strings(keysForURIs)
		for _, k := range keysForURIs {
			dAtA[i] = 0xa
			i++
			v := m.URIs[string(k)]
			msgSize := 0
			...
			mapSize := 1 + len(k) + sovJobs(uint64(len(k))) + msgSize
			i = encodeVarintJobs(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
	...
	if len(m.KVs) > 0 {
		keysForKVs := make([]string, 0, len(m.KVs))
		for k := range m.KVs {
			keysForKVs = append(keysForKVs, string(k))
		}
		github_com_gogo_protobuf_sortkeys.Strings(keysForKVs)
		for _, k := range keysForKVs {
			dAtA[i] = 0x12
			i++
			v := m.KVs[string(k)]
			msgSize := 0
	...
	if len(m.SSTs) > 0 {
		keysForSSTs := make([]string, 0, len(m.SSTs))
		for k := range m.SSTs {
			keysForSSTs = append(keysForSSTs, string(k))
		}
		github_com_gogo_protobuf_sortkeys.Strings(keysForSSTs)
		for _, k := range keysForSSTs {
			dAtA[i] = 0x1a
			i++
			v := m.SSTs[string(k)]
			msgSize := 0
...
func (m *ImportDetails_TableProgress_Progress) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ImportDetails_TableProgress_Progress) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Total != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintJobs(dAtA, i, uint64(m.Total))
	}
	if m.Done != 0 {
		dAtA[i] = 0x15
		i++
		i = encodeFixed32Jobs(dAtA, i, uint32(math.Float32bits(float32(m.Done))))
	}
	return i, nil
}
...
func (m *SchemaChangeDetails) MarshalTo(dAtA []byte) (int, error) {
	...
	n9, err := m.ReadAsOf.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n9
...
func (m *Payload) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DescriptorIDs) > 0 {
		dAtA11 := make([]byte, len(m.DescriptorIDs)*10)
		var j10 int
	...
	if m.Details != nil {
		nn13, err := m.Details.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn13
...
func (m *Payload_Backup) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Backup != nil {
		...
		n14, err := m.Backup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *Payload_Restore) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Restore != nil {
		...
		n15, err := m.Restore.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *Payload_SchemaChange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SchemaChange != nil {
		...
		n16, err := m.SchemaChange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *Payload_Import) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Import != nil {
		...
		n17, err := m.Import.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *ImportDetails_TableProgress) Size() (n int) {
	var l int
	_ = l
	if len(m.URIs) > 0 {
...
func (m *ImportDetails_TableProgress_Progress) Size() (n int) {
	var l int
	_ = l
	if m.Total != 0 {
		n += 1 + sovJobs(uint64(m.Total))
	}
	if m.Done != 0 {
		n += 5
	}
...
func (m *ImportDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableProgress", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TableProgress = append(m.TableProgress, ImportDetails_TableProgress{})
			if err := m.TableProgress[len(m.TableProgress)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ImportDetails_TableProgress) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			if m.URIs == nil {
				m.URIs = make(map[string]*ImportDetails_TableProgress_Progress)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				mapvalue := &ImportDetails_TableProgress_Progress{}
				if err := mapvalue.Unmarshal(dAtA[iNdEx:postmsgIndex]); err != nil {
					return err
				}
				iNdEx = postmsgIndex
				m.URIs[mapkey] = mapvalue
			} else {
				var mapvalue *ImportDetails_TableProgress_Progress
				m.URIs[mapkey] = mapvalue
			}
			iNdEx = postIndex
		case 2:
			...
			iNdEx = postStringIndexmapkey
			if m.KVs == nil {
				m.KVs = make(map[string]*ImportDetails_TableProgress_Progress)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 3:
			...
			iNdEx = postStringIndexmapkey
			if m.SSTs == nil {
				m.SSTs = make(map[string]*ImportDetails_TableProgress_Progress)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *ImportDetails_TableProgress_Progress) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			m.Done = float32(math.Float32frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipJobs(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorJobs = []byte{
	...
	,
}
